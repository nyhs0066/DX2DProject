...
MYCOLLISION_TYPE MyCollision::pointToRect(const MyVector2F& pt, const MyRect& rt)
{
...
MYCOLLISION_TYPE MyCollision::rectToRect(const MyRect& r1, const MyRect& r2, MyRect* outInst)
{
