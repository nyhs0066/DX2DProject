...
public:
	...
	MyExRect m_SPRect;			//위치 사각형
	MyExRect m_TRect;				//텍스처 사각형
	MyExRect m_CSRect;			//충돌 판정 사각형
	MyExRect m_BRect;				//경계 영역 사각형
	...
	virtual bool update();
	virtual void setPosRect(MyExRect posRt);
	...
	virtual bool preRender(const MyExRect& camRt);
