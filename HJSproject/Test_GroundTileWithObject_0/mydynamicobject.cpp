...
bool MyDynamicObject2D::frame()
{
	...
	if (m_pRect.pos.x > m_boundary.fWH.v[0] - 24.0f - m_pRect.fWH.v[0])
	{
		m_pRect.pos.x = m_boundary.fWH.v[0] - 24.0f - m_pRect.fWH.v[0];
		m_vDirection.x = -m_vDirection.x;
	}
	...
	if (m_pRect.pos.y > m_boundary.fWH.v[1] - m_pRect.fWH.v[1])
	{
		m_pRect.pos.y = m_boundary.fWH.v[1] - m_pRect.fWH.v[1];
		m_vDirection.y = -m_vDirection.y;
	}
