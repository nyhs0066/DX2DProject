...
bool TestCase::init()
{
	...
	//Pause BG Set
	pauseBGObj.create(rPaths[0] + L"mydefaultshader.txt", rPaths[1] + L"pause_background.png");
...
bool TestCase::frame()
{
	if (MAININPUT.getKeyState(VK_ESCAPE) == KEY_DOWN)
	{
		pauseFlag = !pauseFlag;
	}
...
GAME_RUN(Test_PauseScene_0, 1000, 1000)