...
bool TestCase::init()
{
	...
	MyRect texRt = pEmptyBar->getTexRect();
	pEmptyBar->setPosRect({ { 100.0f, 800.0f }, {380.0f, 18.0f} });
	...
	pBar->setPosRect({ { 100.0f, 800.0f },  {380.0f, 18.0f} });
...
bool TestCase::release()
{
	...
	if (pEmptyBar) { pEmptyBar->release(); delete pEmptyBar; pEmptyBar = nullptr; }

	return true;
}

GAME_RUN(Test_UIBar, 1000, 1000)