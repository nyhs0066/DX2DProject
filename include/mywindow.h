...
#define GAME_WNDCNSHOW(s, x, y) TestCase instance; bool createFlag = instance.createAndShow(L#s, WS_OVERLAPPEDWINDOW, x, y); if(!createFlag) { return false; } instance.run(); return 0;
#define GAME_END }
